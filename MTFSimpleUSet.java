...
public class MTFSimpleUSet<E> implements SimpleUSet<E> {
     ...
     * When searching for a node containing x (or more precisely, a node
     * containing y satisfying x.equals(y)) if such a node is found, move
     * that node to the head of the linked list.
     *
     */
